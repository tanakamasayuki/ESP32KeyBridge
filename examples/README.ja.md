...
- `EventInput`: `esp32keybridge::InputEvent` を `esp32keybridge::EventInputAdapter` に投入して state を作る例。
...
- `NonKeyboardReports`: Consumer Control や Pointer button / axis を HID report builder へ渡す例。
