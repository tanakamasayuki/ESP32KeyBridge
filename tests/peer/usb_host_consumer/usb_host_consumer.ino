// Peer smoke test, host board: consumer control events from a USB device
// merge into the bridge key set through the keyboard input adapter. The
// peer device board acts as a consumer control device (media remote).
//
